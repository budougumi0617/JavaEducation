...
public class Clock extends Frame implements ActionListener,Runnable, ComponentListener{
	/**
	...
	private static final long serialVersionUID = 1L;
		...
		private int windowPositonX = this.intLoad("windowPositonX", 100);
		private int windowPositonY = this.intLoad("windowPositonY", 100);
		...
		Clock(){
			...
			this.addWindowListener(new CloseWindow(prefs, this.wSize));
		}
