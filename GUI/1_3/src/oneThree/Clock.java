...
public class Clock extends Window
	...
	private static final long serialVersionUID = 1L;
		...
		public void mousePressed(MouseEvent e) {
			if (e.isPopupTrigger()) propMenu.show(this , e.getX() , e.getY());
		}
	...
	public void paint(Graphics g)
	{
		...
		//this.setBounds(clockX, clockY, (int)(strWidth*1.5), (int)(strHeight*1.5) );
		...
		offGraph.drawString(h+":"+m+":"+s,strWidth/4,(int)(strHeight*1));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Serif") this.fontName = "Serif";
		if (e.getActionCommand() == "SansSerif") this.fontName = "SansSerif";
		if (e.getActionCommand() == "Large") this.fontSize = 100;
		if (e.getActionCommand() == "Normal") this.fontSize = 50;
		if (e.getActionCommand() == "Black") this.fontColor = Color.black;
		if (e.getActionCommand() == "White") this.fontColor = Color.white;
		if (e.getActionCommand() == "BackBlack") this.backColor = Color.black;
		if (e.getActionCommand() == "BackWhite") this.backColor = Color.white;
	...
	public void mouseDragged(MouseEvent e) {
		...
		clockX  = e.getX();// - x;
		clockY  = e.getY();// - y;
		System.out.println("Dragged: clockX = " + clockX  + " clockY = " + clockY);
